...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/anyascii-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14104&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/anyascii-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `anyascii` can be installed with:

```
conda install anyascii
```

It is possible to list all of the versions of `anyascii` available on your platform with:
